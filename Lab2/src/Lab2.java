...
public class Lab2 {
	...
	public static void main(String[] args) throws IOException {
		...
		//Loop will run at least once as the string is initialized to nothing, and will stop on input of 9.
		while(!array.equals("9")) {
			lab.displayMainMenu();
			array = scan.next();
			//The 9 possible cases with a default case that handles any invalid input.
			switch (array) {
				case "1":
					//Creates default array of size 10 with 0 numItems.
					numbers = new Numbers();
					break;
				case "2":
					System.out.print("Please enter the size of the array: ");
					//Try/Catch for 2 exceptions of invalid input and negative array size.
					try {
					...
					break;
				case "3":
					//Prompts user to enter a float value into the array.
					System.out.print("Enter a float value: ");
					numbers.addValue(scan);
					break;
				case "4":
					//Prints out each number of the array line by line.
					System.out.print("Numbers are:\n" + numbers);
					break;
				case "5":
					//Displays the average of the array alongside my created method of the median as well.
					...
					break;
				case "6":
					//Prompt to determine amount of numbers to be added to the array without allowing it to be full.
					...
					break;
				case "7":
					//Prompt user for the file to read the values from.
				...
				case "8":
					//Prompts the user to enter the name of the file to save the values of the array to.
					System.out.print("Enter file name: ");
					...
					break;
				case "9":
					//Displays exit message and stops the program.
	...
	//Simple display to show all the different options to choose from.
