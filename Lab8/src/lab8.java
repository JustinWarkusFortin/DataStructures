...
public class lab8 {
	public static void main(String[] args) {
		...
		String choice = "";
		/**
		 * While loop that handles the 3 possible cases of user input, including the add
		 * string, searching for a string as well as exiting the program
		 */
		while (choice != "3") {
			System.out.print("\n1.Add\n2.Search\n3.Exit\n>");
			choice = scan.next();
			...
			case "2":
				...
				int index2 = (c + d) % 100;
				// Checks if the string is in the ArrayList and if it is will print its index,
				// otherwise will fail and print a message.
